...
const SLIDERS:Slider[] = [
  ...
  { key:'minLegShare', label:'Shortest leg share', min:0, max:1, step:0.01, default:0.08,
    ...
    ...quality('minLegShare') },
  { key:'maxOutAndBackSpurMetres', label:'Backtrack floor (m)', min:0, max:3000, step:50, default:150,
  ...
  { key:'maxOutAndBackSpurShare', label:'Backtrack share', min:0, max:1, step:0.01, default:0.04,
    hint:'Doubled-back ground allowed as a fraction of the whole walk’s length. 1 turns this rule off.',
