...
#ifndef LOOPER_SWIFT_H
#define LOOPER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Looper",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Looper15LocationManager")
...
@class CLLocation;
@class CLHeading;
@interface LocationManager (SWIFT_EXTENSION(Looper)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC6Looper13SpeechManager")
...
@interface SpeechManager (SWIFT_EXTENSION(Looper)) <AVSpeechSynthesizerDelegate>
